...
BOOL	CEchoRQ :: Write ( PDU_Service *PDU )
	...
	leMessageID = SwitchEndian((UINT16)Temp);
#endif //Big Endian
...
BOOL	CEchoRSP :: Write ( PDU_Service *PDU, DICOMCommandObject *DCO,
	...
	leError = ErrorCode;
#else //Big Endian like Apple power pc
	leError = SwitchEndian((UINT16)ErrorCode);
#endif //Big Endian
...
BOOL	CStoreRQ :: Read (
	...
	if ( DCO->GetUINT16(0x0000, 0x0100) != EN0001 )
...
BOOL	CStoreRSP	::	Read ( DICOMCommandObject	*DCO )
	...
	if (DCO->GetUINT16(0x0000, 0x0100) != EN8001)
...
#else //Big Endian like Apple power pc
	if(DCO->GetVR(0x0000, 0x0700))
		lePriority = SwitchEndian((UINT16) DCO->GetUINT16( 0x0000, 0x0700 ));
	leErrorCode = SwitchEndian((UINT16) ErrorCode);
#endif //Big Endian
//Note: Is switched in incomming, no need to switch again
...
BOOL	CFindRQ :: Read (
	...
	if ( DCO->GetUINT16(0x0000, 0x0100) != EN0020 )
...
BOOL	CFindRSP	::	Read (
	...
	if (DCO->GetUINT16(0x0000, 0x0100) != EN8020)
...
BOOL	CMoveRQ :: Read (
	...
	if ( DCO->GetUINT16(0x0000, 0x0100) != EN0021 )
...
BOOL	CMoveRSP	::	Read (
	...
	if (DCO->GetUINT16(0x0000, 0x0100) != EN8021)
...
BOOL	CMoveRSP	::	Write (
	...
	if(DCO->GetVR(0x0000, 0x0700))
		lePriority = DCO->GetUINT16( 0x0000, 0x0700 );
	leNumberRemaining = SwitchEndian((UINT16) NumberRemaining);
	leNumberComplete = SwitchEndian((UINT16) NumberComplete);
	leNumberFailed = SwitchEndian((UINT16) NumberFailed);
	leNumberWarning = SwitchEndian((UINT16) NumberWarning);
	leErrorCode = SwitchEndian((UINT16) ErrorCode);
#endif //Big Endian
//Note: Is switched in incomming, no need to switch again
	leRQMessageID = DCO->GetUINT16 ( 0x0000, 0x0110 );
